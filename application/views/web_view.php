        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12"
                    ...
                    <img src="<?php echo BASE_URL; ?>static/images/slider-icon.png"
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-7 col-md-12 col-sm-12" data-scroll-reveal="enter left move 30px over 0.6s after 0.4s">
                <img src="<?php echo BASE_URL; ?>static/images/left-image.png" class="rounded img-fluid d-block mx-auto"
                    alt="App">
            </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="right-image col-lg-7 col-md-12 col-sm-12 mobile-bottom-fix-big"
                data-scroll-reveal="enter right move 30px over 0.6s after 0.4s">
                <img src="<?php echo BASE_URL; ?>static/images/right-image.png"
        ...
        <div class="row">
            <div class="owl-carousel owl-theme">
                <div class="item service-item">
                    <div class="icon">
                        <i><img src="<?php echo BASE_URL; ?>static/images/service-icon-01.png" alt=""></i>
                    </div>
                ...
                <div class="item service-item">
                    <div class="icon">
                        <i><img src="<?php echo BASE_URL; ?>static/images/service-icon-02.png" alt=""></i>
                    </div>
                ...
                <div class="item service-item">
                    <div class="icon">
                        <i><img src="<?php echo BASE_URL; ?>static/images/service-icon-03.png" alt=""></i>
                    </div>
